    ...
    return (
        <div className="h-full flex flex-col items-center justify-center gap-4 backdrop-blur-md bg-white/30 dark:bg-black/30 p-8 lg:rounded-l-3xl">
            <div className="flex flex-col items-center justify-center">
                <h1 className="font-bold lg:text-3xl md:text-2xl text-xl text-zinc-800 dark:text-zinc-300">
                    Resultado
                </h1>
                <p className="lg:text-lg md:text-base text-sm text-zinc-600 dark:text-zinc-400">Tus puntos son:</p>
            </div>
            <div className="flex gap-4">
                <p className="font-bold font-montserrat xl:text-9xl lg:text-8xl md:text-7xl text-6xl text-zinc-800 dark:text-white lg:-mt-8 md:-mt-6 -mt-4">
                    {currentEnvido}
                </p>
            </div>
        </div>
